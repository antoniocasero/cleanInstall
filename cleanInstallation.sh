...
RUBY_VERSION=2.4.0
  ...
  git lfs install
      ...
      echo "Brew packages"
  for pkg in alfred dropbox google-chrome vlc fastlane spotify appcode atom insomnia go2shell docker ngrok spotify visual-studio-code intellij-idea-ce vlc sourcetree cisco-spark box-sync bettertouchtool; do
